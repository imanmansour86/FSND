...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_delete_question(self):
        ...
        question = Question(question='new question', answer='answer',category=1,difficulty=3 )
        question.insert()
        id = question.id
        ...
        self.assertTrue(data['total_questions']) # assert true there is a number of total questions 
        self.assertEqual(deleted_question, None) # check the question no longer exists
    ...
    def test_create_new_question(self):
        res = self.client().post('/questions', json=self.new_question) # send a json of the object created during setup
    ...
    def test_play_quiz(self):
        res = self.client().post('/quizzes', json={'previous_questions': [6], 'quiz_category' : {'type': 'Art', 'id':2 }})
        data = json.loads(res.data)
